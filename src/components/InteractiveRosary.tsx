  ...
  return (
    <div className="bg-gradient-to-br from-marian-blue-50 to-marian-blue-200 min-h-screen text-gray-800 dark:text-gray-200 flex flex-col items-center justify-center p-4 selection:bg-marian-blue-200">
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3 w-full flex items-center justify-center order-1 lg:order-2 sticky top-12 lg:top-0 z-10 bg-marian-blue-100/80 dark:bg-gray-900/80 backdrop-blur-md h-[360px] lg:h-auto shadow-lg rounded-b-2xl lg:shadow-none lg:rounded-none lg:bg-transparent dark:lg:bg-transparent">
          <Rosary
