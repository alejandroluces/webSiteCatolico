...
const Blog: React.FC = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: 'La oración en familia fortalece los lazos y acerca a todos los miembros a Dios. Aprende cómo establecer este hábito sagrado.',
      content: 'La familia que reza unida permanece unida. Esta frase, aunque simple, encierra una verdad profunda sobre la vida cristiana...',
    ...
    },
    {
      ...
      excerpt: 'Conoce a los santos que interceden especialmente por quienes buscan conocimiento y sabiduría en sus estudios.',
      content: 'El estudio es una forma de oración cuando se realiza con la intención de conocer mejor la verdad y servir a Dios...',
      ...
      tags: ['santos', 'estudiantes', 'sabiduría'],
    },
    {
      id: 4,
      title: 'El sacramento de la Reconciliación: Guía completa',
      slug: 'sacramento-reconciliacion-guia',
      excerpt: 'Todo lo que necesitas saber sobre la confesión: cómo prepararse, qué decir y cómo vivir el perdón de Dios.',
      content: 'La confesión es uno de los regalos más hermosos que Cristo nos ha dado a través de su Iglesia...',
      author: 'Padre Miguel Rodríguez',
      date: '8 de Enero, 2025',
      category: 'sacramentos',
      readTime: '8 min',
      image: 'https://images.pexels.com/photos/8815021/pexels-photo-8815021.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
      tags: ['confesión', 'perdón', 'sacramentos'],
    },
    {
      id: 5,
      title: 'Cómo enseñar el catecismo a los niños',
      slug: 'ensenar-catecismo-ninos',
      excerpt: 'Métodos creativos y efectivos para transmitir la fe católica a los más pequeños de la casa.',
      content: 'Jesús dijo: "Dejad que los niños vengan a mí". Enseñar la fe a los niños es una responsabilidad y un privilegio...',
      author: 'María González',
      ...
      tags: ['catecismo', 'niños', 'educación'],
    },
    {
      id: 6,
      title: 'La devoción al Rosario: Historia y práctica',
      slug: 'devocion-rosario-historia',
      excerpt: 'Descubre la rica historia del Santo Rosario y cómo esta oración mariana puede transformar tu vida espiritual.',
      content: 'El Rosario es una de las devociones más queridas y poderosas de la Iglesia Católica...',
      author: 'Padre Miguel Rodríguez',
      date: '3 de Enero, 2025',
      category: 'oracion',
      readTime: '6 min',
      image: 'https://images.pexels.com/photos/8815016/pexels-photo-8815016.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
      tags: ['rosario', 'maría', 'devoción'],
    },
  ];
