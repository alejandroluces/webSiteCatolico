process.env.REMOVED_TLS_BYPASS_ENV = '0';
...
const ID_INSTANCE = cleanEnv(process.env.GREEN_API_ID_INSTANCE) || '***REMOVED_GREEN_API_INSTANCE***';
const API_TOKEN = cleanEnv(process.env.GREEN_API_TOKEN) || '***REMOVED_GREEN_API_TOKEN***';
...
const ELEVENLABS_API_KEY = cleanEnv(process.env.ELEVENLABS_API_KEY) || '***REMOVED_ELEVENLABS_KEY***';
